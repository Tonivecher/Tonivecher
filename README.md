...
### 01 / Estimate Platform (Smeta SaaS)

[![B2B SaaS-платформа строительных смет с двухконтурной генерацией PDF и XLSX](./assets/profile/estimate-platform-saas.gif)](https://github.com/Tonivecher/estimate-platform-saas)

B2B-платформа для строительных и отделочных компаний: расчёт смет, контроль маржинальности объектов, управление этапами работ и двухконтурный выпуск документов.

Система разделяет финансовые потоки на два контура: внутренний (полная себестоимость, оптовые закупки, оплата мастеров и чистая маржа) и клиентский (чистое коммерческое предложение без раскрытия внутренних наценок). Генераторы на ReportLab и XlsxWriter на лету собирают типографические векторные PDF формата A4 и формульные Excel-таблицы.

`FASTAPI` · `REACT 19` · `PYTHON 3.12` · `POSTGRESQL` · `REPORTLAB` · `DOCKER`

[Посмотреть архитектуру и исходный код ↗](https://github.com/Tonivecher/estimate-platform-saas) · [Запросить enterprise-интеграцию ↗](https://t.me/ai_nickolai)
...
У проектов выше проверены релизные сборки и живые адреса. Для Estimate Platform
написаны 67 серверных тестов и подтверждена корректность обоих контуров смет. Для Agent Office я
